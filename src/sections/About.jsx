...
const About = () => {
  ...
  return (
    <section
      ref={ref}
      id="nosotros"
      className={`reveal relative overflow-hidden ${isVisible ? 'is-visible' : ''}`}
    >
      <div
      ...
      <div className="relative max-w-7xl mx-auto px-6 py-10 md:py-16 grid md:grid-cols-2 gap-12 items-center">
        <motion.div
        ...
        <div className="relative flex items-center justify-center">
          ...
          <div className="relative w-full max-w-xs md:max-w-sm flex flex-col items-center group">
            <img
              src={logo}
